...
{
for(int j = 1; j <=y;j++)//Second for loop for printing pattern until
                         //number of columns
{
...
void polygon(int a)//function polygon declared with 
                  //1 int argument
{
for(int i = 1;i <=a;i++)//First for loop for printing starting of one set
                        //of 1's and giving spaces
{
System.out.print("1");
...
PolyConstructor po = new PolyConstructor();//Declaring object to use 
                                         //PolyConstructor class
System.out.println("Enter choice (1. int and char 2. int and int 3. int)");
...
po.polygon(f,ch1);//function polygon with 2 arguments is called with
       //values of f and ch being passed to it
...
po.polygon(h,z);//function polygon with 2 arguments is called with
       //values of h and z being passed to it
break;//break statement terminates statements in case
...
po.polygon(e);//function polygon with 1 argument is called with
       //value of e being passed to it
}
}
}
